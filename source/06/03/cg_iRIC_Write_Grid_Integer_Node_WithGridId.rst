.. _sec_ref_cg_iRIC_Write_Grid_Integer_Node_WithGridId:

cg_iRIC_Write_Grid_Integer_Node_WithGridId
==========================================

nodes the integer grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Integer_Node_WithGridId(fid, gid, name, v_arr)
