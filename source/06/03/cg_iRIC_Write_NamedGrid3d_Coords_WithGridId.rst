.. _sec_ref_cg_iRIC_Write_NamedGrid3d_Coords_WithGridId:
...
.. code-block:: python
   ...
   cg_iRIC_Write_NamedGrid3d_Coords_WithGridId(fid, name, isize, jsize, ksize, x_arr, y_arr, z_arr, gid)
