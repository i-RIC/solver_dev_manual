.. _sec_ref_cg_iRIC_Write_Sol_IFace_Real_WithGridId:

cg_iRIC_Write_Sol_IFace_Real_WithGridId
=======================================

Writes the double precision real calculation result defined at grid I-direction cell boudary faces (edges).
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_IFace_Real_WithGridId(fid, gid, name, v_arr)
