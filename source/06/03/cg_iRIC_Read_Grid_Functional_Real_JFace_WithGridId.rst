.. _sec_ref_cg_iRIC_Read_Grid_Functional_Real_JFace_WithGridId:

cg_iRIC_Read_Grid_Functional_Real_JFace_WithGridId
==================================================

Reads the J-direction cell boudary faces (edges) values of grid attribute with time dimension defined at double precision real.
