.. _sec_ref_cg_iRIC_Write_Sol_Cell_Real:

cg_iRIC_Write_Sol_Cell_Real
===========================

Writes the double precision real calculation result defined at grid cells.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_Cell_Real(fid, name, v_arr)
