.. _sec_ref_cg_iRIC_Write_Grid_Complex_IFace:

cg_iRIC_Write_Grid_Complex_IFace
================================

I-direction cell boudary faces (edges) the complex type grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Complex_IFace(fid, groupname, v_arr)
