.. _sec_ref_cg_iRIC_Write_Grid_Complex_Node_WithGridId:

cg_iRIC_Write_Grid_Complex_Node_WithGridId
==========================================

nodes the complex type grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Complex_Node_WithGridId(fid, gid, groupname, v_arr)
