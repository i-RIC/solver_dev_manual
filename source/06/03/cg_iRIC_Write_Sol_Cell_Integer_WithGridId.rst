.. _sec_ref_cg_iRIC_Write_Sol_Cell_Integer_WithGridId:

cg_iRIC_Write_Sol_Cell_Integer_WithGridId
=========================================

Writes the integer calculation result defined at grid cells.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_Cell_Integer_WithGridId(fid, gid, name, v_arr)
