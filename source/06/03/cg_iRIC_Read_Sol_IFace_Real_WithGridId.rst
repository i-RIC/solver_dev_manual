.. _sec_ref_cg_iRIC_Read_Sol_IFace_Real_WithGridId:

cg_iRIC_Read_Sol_IFace_Real_WithGridId
======================================

Reads the double precision real calculation result defined at grid I-direction cell boudary faces (edges).
