.. _sec_ref_cg_iRIC_Read_Sol_PolyData_CoordinateCount_WithGridId:

cg_iRIC_Read_Sol_PolyData_CoordinateCount_WithGridId
====================================================

Reads the sum of the number of nodes constituting polygons or poly lines
...
.. list-table:: Description of count
   ...
   * - Description
     - The sum of number of vertices constituting the polygons (or the poly lines)
   * - Data type (FORTRAN)
     - integer
   * - Data type (C/C++)
     - int*
