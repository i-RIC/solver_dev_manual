.. _sec_ref_cg_iRIC_Write_BC_FunctionalWithName_WithGridId:

cg_iRIC_Write_BC_FunctionalWithName_WithGridId
==============================================

Writes the variable values of functional boundary condition. This should be used in case it has multiple values.
...
.. code-block:: python
   ...
   cg_iRIC_Write_BC_FunctionalWithName_WithGridId(fid, gid, type, num, name, paramname, length, v_arr)
