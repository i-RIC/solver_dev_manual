.. _sec_ref_cg_iRIC_Read_BC_FunctionalWithName_WithGridId:

cg_iRIC_Read_BC_FunctionalWithName_WithGridId
=============================================

Reads the variable values of functional boundary condition. This should be used in case it has multiple values.
