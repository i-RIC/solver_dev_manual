.. _sec_ref_cg_iRIC_Write_Sol_JFace_Real_WithGridId:

cg_iRIC_Write_Sol_JFace_Real_WithGridId
=======================================

Writes the double precision real calculation result defined at grid J-direction cell boudary faces (edges).
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_JFace_Real_WithGridId(fid, gid, name, v_arr)
