.. _sec_ref_cg_iRIC_Write_Grid_Integer_Cell_WithGridId:

cg_iRIC_Write_Grid_Integer_Cell_WithGridId
==========================================

cells the integer grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Integer_Cell_WithGridId(fid, gid, name, v_arr)
