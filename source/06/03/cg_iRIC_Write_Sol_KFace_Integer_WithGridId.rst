.. _sec_ref_cg_iRIC_Write_Sol_KFace_Integer_WithGridId:

cg_iRIC_Write_Sol_KFace_Integer_WithGridId
==========================================

Writes the integer calculation result defined at grid K-direction cell boudary faces (edges).
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_KFace_Integer_WithGridId(fid, gid, name, v_arr)
