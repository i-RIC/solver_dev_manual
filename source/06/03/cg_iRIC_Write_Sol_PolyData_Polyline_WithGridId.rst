...
Writes the poly line shape for the calculation result defined as poly lines.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_PolyData_Polyline_WithGridId(fid, gid, numPoints, x_arr, y_arr)
