.. _sec_ref_cg_iRIC_Write_Sol_Particle_Real_WithGridId:

cg_iRIC_Write_Sol_Particle_Real_WithGridId
==========================================

Writes the double precision real calculation result defined at grid Particles.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_Particle_Real_WithGridId(fid, gid, name, v_arr)
