.. _sec_ref_cg_iRIC_Read_Grid_Functional_Integer_JFace:

cg_iRIC_Read_Grid_Functional_Integer_JFace
==========================================

Reads the J-direction cell boudary faces (edges) values of grid attribute with time dimension defined at integer.
