.. _sec_ref_cg_iRIC_Write_Grid_Complex_JFace_WithGridId:

cg_iRIC_Write_Grid_Complex_JFace_WithGridId
===========================================

J-direction cell boudary faces (edges) the complex type grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Complex_JFace_WithGridId(fid, gid, groupname, v_arr)
