.. _sec_ref_cg_iRIC_Write_Grid_Integer_IFace_WithGridId:

cg_iRIC_Write_Grid_Integer_IFace_WithGridId
===========================================

I-direction cell boudary faces (edges) the integer grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Integer_IFace_WithGridId(fid, gid, name, v_arr)
