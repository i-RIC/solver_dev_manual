.. _sec_ref_cg_iRIC_Write_Sol_Particle_Integer_WithGridId:

cg_iRIC_Write_Sol_Particle_Integer_WithGridId
=============================================

Writes the integer calculation result defined at grid Particles.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Sol_Particle_Integer_WithGridId(fid, gid, name, v_arr)
