.. _sec_ref_cg_iRIC_Read_Complex_FunctionalWithName:

cg_iRIC_Read_Complex_FunctionalWithName
=======================================

Reads the variable values of functional complex type grid attribute. This should be used in case it has multiple values.
