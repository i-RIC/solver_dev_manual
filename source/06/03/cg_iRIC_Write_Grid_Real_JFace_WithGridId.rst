.. _sec_ref_cg_iRIC_Write_Grid_Real_JFace_WithGridId:

cg_iRIC_Write_Grid_Real_JFace_WithGridId
========================================

J-direction cell boudary faces (edges) the double precision real grid attribute values defined at Writes.
...
.. code-block:: python
   ...
   cg_iRIC_Write_Grid_Real_JFace_WithGridId(fid, gid, name, v_arr)
